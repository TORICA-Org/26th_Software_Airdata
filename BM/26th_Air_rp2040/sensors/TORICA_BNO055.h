...
bool TORICA_BNO055_init(TwoWire &wire, uint8_t addr = 0x28);
...
bool TORICA_BNO055_getCalibration(volatile uint8_t &sys, volatile uint8_t &gyro, volatile uint8_t &accel, volatile uint8_t &mag);
